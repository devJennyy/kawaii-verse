  ...
  return (
    <>
      ...
      <div className="w-full h-full bg-[#09090B] text-white">
        ...
        <div
          id="explore"
          className="flex flex-col w-full h-[300vh] bg-[#09090B]"
        >
          {/* Most Popular Anime */}
                  ...
                  <div className="h-fit w-[750px]">
                    ...
                    <div className="flex text-left text-[14px] font-extralight mt-2 italic">
                      <p>
                        ...
                        distinctio pariatur animi rerum maximew. Lorem ipsum
                        dolor sit amet consectetur adipisicing elit. Earum,
                        voluptate soluta et ex aspernatur explicabo in iste.
                      </p>
                    </div>
                  </div>
                </div>
